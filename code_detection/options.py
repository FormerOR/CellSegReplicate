...
class Options:
    def __init__(self, isTrain):
        ...
        self.model = dict()
        self.model['name'] = 'ResUNet34'  #TODO:原始模型为ResUNet34
        ...
        self.test['gpus'] = [0, ]
        self.test['threshold'] = 0.6 #TODO:原始阈值为0.35
        ...
        if self.dataset == 'LC':
            ...
            self.post['max_area'] = 500 #TODO:原始最大面积为200
        # self.post['min_area'] = 12
        self.post['min_area'] = 50 #TODO:原始最小面积为12
